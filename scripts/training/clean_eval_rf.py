"""Clean RF prediction raster by removing tiny positive blobs and evaluate."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Remove small connected positive components from the RF prediction raster "
    ...
    parser.add_argument(
        ...
        help="Input classification raster (RF).",
    )
    parser.add_argument(
        "--cleaned-raster",
        type=Path,
        default=Path("map/tsukuba_solarpanel_class_rf_grid_cleaned.tif"),
    ...
    parser.add_argument(
        "--csv-output",
        type=Path,
        default=Path("map/rf_cleaning_metrics.csv"),
